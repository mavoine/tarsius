...
public class PhotoCell extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		// TODO investigate use of JTable.getCellRectangle()
		...
		g.drawImage(this.image, xOffset, yOffset, 
				(int)clip.getWidth(), (int)clip.getHeight(), Color.BLACK, null);
		if(log.isTraceEnabled()){
			log.trace("Time taken to paintComponent(): " 
